<template>
    <el-row type="flex" justify="center" align="middle">
        <el-col class="login-box">
            <el-card header="Yet Another Laravel-SPA-Admin 管理后台 - 系统初始化">
                <el-form :model="form" ref="form" @keyup.native.enter="doLogin('form')" label-position="left" label-width="0px" >
                    <el-form-item prop="username">
                        <el-input type="text" v-model="form.username" auto-complete="off" placeholder="installer 账号"></el-input>
                    </el-form-item>
                    <el-form-item prop="password">
                        <el-input type="password" v-model="form.password" auto-complete="off" placeholder="installer 密码"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item style="width:100%;">
                        <el-button type="success" style="width:100%;" v-loading="loading"
...
<script>
    export default {
        ...
        methods: {
            getCaptchaUrl(){
                return location.protocol + '//' +location.host + '/captcha/' + this.captcha_img_type  + '?v=' + Math.random();
            },
            refreshCaptcha(){
        ...
        created: function () {
            if (this.$store.getters.userHasLoggedIn) {
                ...
                this.captcha_img_src = this.getCaptchaUrl()
            }
        }
    }
